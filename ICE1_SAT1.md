# ICE1_SAT1.csv Codebook

**Filename:** `ICE1_SAT1.csv`  
...
Fill in one row per column in `ICE1_SAT1.csv`.
...
```r
df <- read.csv("ICE1_SAT1.csv", header = TRUE)
```
