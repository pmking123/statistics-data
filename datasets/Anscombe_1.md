# Anscombe_1.csv Codebook

**Filename:** `Anscombe_1.csv`  
...
Fill in one row per column in `Anscombe_1.csv`.
...
```r
df <- read.csv("Anscombe_1.csv", header = TRUE)
```
