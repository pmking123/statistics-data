...
- **Data repository:** [https://pmking123.github.io/statistics-data/datasets/trial.csv](https://pmking123.github.io/statistics-data/datasets/trial.csv)
...
| `sex`   | factor: 0 = female, 1 = male | | Sex of the trial participant |
...
```r
df <- read.csv("https://pmking123.github.io/statistics-data/datasets/trial.csv", header = TRUE)
```
...
```r
library(readr)
df <- read_csv("https://pmking123.github.io/statistics-data/datasets/trial.csv")
```
...
```python
import pandas as pd
df = pd.read_csv("https://pmking123.github.io/statistics-data/datasets/trial.csv")
```
