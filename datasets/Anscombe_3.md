# Anscombe_3.csv Codebook

**Filename:** `Anscombe_3.csv`  
...
Fill in one row per column in `Anscombe_3.csv`.
...
```r
df <- read.csv("Anscombe_3.csv", header = TRUE)
```
