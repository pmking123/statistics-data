# Anscombe_4.csv Codebook

**Filename:** `Anscombe_4.csv`  
...
Fill in one row per column in `Anscombe_4.csv`.
...
```r
df <- read.csv("Anscombe_4.csv", header = TRUE)
```
