# blood_eye.csv Codebook

**Filename:** `blood_eye.csv`  
...
Fill in one row per column in `blood_eye.csv`.
...
```r
df <- read.csv("blood_eye.csv", header = TRUE)
```
