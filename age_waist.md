# age_waist.csv Codebook

**Filename:** `age_waist.csv`  
...
Fill in one row per column in `age_waist.csv`.
...
```r
df <- read.csv("age_waist.csv", header = TRUE)
```
